...
public class IdentCodeUtils {
    ...
    public static void getIdentCode(HttpServletRequest request, HttpServletResponse response) throws IOException {
        int width = 120;
        int height = 30;
        ...
        // 将生成的字母存入到session中
        request.getSession().setAttribute("identCode", sb.toString());
