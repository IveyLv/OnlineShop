    ...
    <div class="span24">
        <div class="wrap">
            <div class="main clearfix">
                ...
                <form id="registerForm" action="${pageContext.request.contextPath}/user_register" method="post" novalidate="novalidate" onsubmit="return checkForm();">
                    <table>
                        <tbody><tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="birth" class="text" onfocus="WdatePicker();">
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
								<span class="fieldSet">
                                    ...
                                    <img id="checkImg" class="captchaImage" src="${pageContext.request.contextPath}/checkImg" onclick="changeImg()" title="点击更换验证码">
								</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <c:if test="${not empty(requestScope.registerMsg)}">
                                    <span style="color: #ff0000;">${requestScope.registerMsg}</span>
                                </c:if>
                            </td>
                        </tr>
                        <tr>
...
<div id="_my97DP" style="position: absolute; top: -1970px; left: -1970px;"><iframe style="width: 190px; height: 191px;" src="#" frameborder="0" border="0" scrolling="no"></iframe></div></body></html>