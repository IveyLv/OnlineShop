    ...
    <div class="span24">
        <div id="hotProduct" class="hotProduct clearfix">
            ...
            <ul class="tabContent" style="display: block;">
                <c:forEach items="${requestScope.hList}" var="hotProduct">
                    <li>
                        <a href="${pageContext.request.contextPath}/product_findByPid?pid=${hotProduct.pid}" target="_blank">
                            <img src="${pageContext.request.contextPath }/${hotProduct.image}"
    ...
    <div class="span24">
        <div id="newProduct" class="newProduct clearfix">
            ...
            <!-- 					<div class="newProductAd">
                                     ...
                                     -->
            <ul class="tabContent" style="display: block;">
                <c:forEach items="${requestScope.nList}" var="newProduct">

                    <li>
                        <a href="${pageContext.request.contextPath}/product_findByPid?pid=${newProduct.pid}" target="_blank">
                            <img src="${pageContext.request.contextPath }/${newProduct.image}"
