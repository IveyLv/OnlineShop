...
<div class="container cart">
    ...
    <div class="span24">
        ...
        <div class="total">
            <em id="promotion"></em>
            商品金额: <strong id="effectivePrice">￥${requestScope.order.total}元</strong>
        </div>
        <form id="orderForm" action="${pageContext.request.contextPath}/order_payOrder" method="post">
            ...
            <div class="span24">
                <p>
                    收货地址：<input name="addr" type="text" value="${requestScope.order.user.addr}" style="width:350px" />
                    <br />
                    收货人&nbsp;&nbsp;&nbsp;：<input name="name" type="text" value="${requestScope.order.user.name}" style="width:150px" />
                    <br />
                    联系方式：<input name="phone" type="text"value="${requestScope.order.user.phone}" style="width:150px" />
